export const CATEGORIES = [
  { id: "sounds", name: "Sounds & DJ", icon: "Music", count: 18, image: "https://images.unsplash.com/photo-1470225620780-dba8ba36b745?auto=format&fit=crop&q=80&w=600" },
  { id: "lighting", name: "Lighting", icon: "Sparkles", count: 14, image: "https://images.unsplash.com/photo-1516450360452-9312f5e86fc7?auto=format&fit=crop&q=80&w=600" },
  { id: "deco", name: "Stage Decorations", icon: "Flower", count: 25, image: "https://images.unsplash.com/photo-1519225495810-7517c24a9463?auto=format&fit=crop&q=80&w=600" },
  { id: "catering", name: "Catering Services", icon: "Utensils", count: 32, image: "https://images.unsplash.com/photo-1555244162-803834f70033?auto=format&fit=crop&q=80&w=600" },
  { id: "costumes", name: "Costume Rentals", icon: "Shirt", count: 11, image: "https://images.unsplash.com/photo-1595777457583-95e059d581b8?auto=format&fit=crop&q=80&w=600" }
];

export const DISTRICTS = ["Colombo", "Gampaha", "Kandy", "Kalutara", "Galle", "Kurunegala"];
...
export const PACKAGES = [
  {
    ...
    price: 150000,
    images: [
      "https://images.unsplash.com/photo-1519225495810-7517c24a9463?auto=format&fit=crop&q=80&w=800",
      "https://images.unsplash.com/photo-1523438885200-e635ba2c371e?auto=format&fit=crop&q=80&w=800",
      "https://images.unsplash.com/photo-1511795409834-ef04bbd61622?auto=format&fit=crop&q=80&w=800"
    ],
    badge: "Most Popular",
    description: "Make your special day unforgettable with our traditional-meets-modern wedding decoration package. Crafted by master decorators using high-quality artificial and fresh local flowers.",
    includes: [
    ...
    addons: [
      ...
      { id: "add-1-4", name: "Matching Table Centerpieces (15 Tables)", price: 18000 }
    ],
  ...
  },
  {
    ...
    badge: "Trending",
    description: "Premium high-fidelity audio system perfect for weddings, homecomings, and corporate gigs. Includes an experienced local DJ playing the best baila, pop, and dance beats.",
    includes: [
    ...
    addons: [
      ...
      { id: "add-2-3", name: "Premium Live Band Mixing Board (32 Ch)", price: 12000 },
      { id: "add-2-4", name: "Karaoke Setup with Screen + Lyrics", price: 15000 }
    ],
  ...
  },
  {
    ...
    badge: "Top Rated",
    description: "Premium buffet with rich local flavors. Features fragrant Basmati rice, 5 traditional Sri Lankan curries, custom sambols, papadum, and delicious local desserts.",
    includes: [
    ...
    addons: [
      { id: "add-3-1", name: "Live String Hopper Action Station (2 hours)", price: 35000 },
      { id: "add-3-2", name: "Watalappan Live Caramel Station", price: 18000 },
      { id: "add-3-3", name: "Premium Ice Carving centerpieces (pair)", price: 20000 },
      { id: "add-3-4", name: "Welcome Drink (Poli-Sambol Woodapple Nectar)", price: 12000 }
    ],
  ...
  },
  {
    ...
    badge: "Best Value",
    description: "Transform your venue space with our computer-controlled moving head lighting fixtures, customized color ambient washes, and amazing haze effects for photos.",
    includes: [
    ...
    addons: [
      { id: "add-4-1", name: "Heavy Dry Ice 'Dancing on Clouds' Fog", price: 18000 },
      { id: "add-4-2", name: "Cold Pyro Indoor Fountains (x4 shots)", price: 15000 },
      { id: "add-4-3", name: "Custom Monogram/Name Laser Gobo Projection", price: 10000 },
      { id: "add-4-4", name: "Extra Ambient Uplighters (10 units)", price: 8000 }
    ],
  ...
  },
  {
    ...
    badge: "Unique",
    description: "Premium rental of traditional Kandyan wedding costumes. High-quality velvet jackets, silver-threaded Mul Anduma set, and hand-crafted gold-plated traditional bridal jewellery.",
    includes: [
    ...
    addons: [
      { id: "add-5-1", name: "Additional Bridesmaid Saree Rental (each)", price: 10000 },
      { id: "add-5-2", name: "Bestman Traditional Groom's Costume Rental", price: 15000 },
      { id: "add-5-3", name: "Mul Anduma Traditional Gold Sword Prop", price: 5000 },
      { id: "add-5-4", name: "Flower Girl Traditional Dress Rental", price: 4000 }
    ],
  ...
  },
  {
    ...
    badge: "Elite Elite",
    description: "Our premium package for grand balls, corporate gatherings, and large scale celebrations. Features dual-line array speaker towers, stunning backdrop designs, and automated stage lighting.",
    includes: [
    ...
    addons: [
      { id: "add-6-1", name: "12x8 ft P3 Premium Outdoor LED Screen", price: 60000 },
      { id: "add-6-2", name: "Live Multi-cam 4K streaming setup", price: 30000 },
      { id: "add-6-3", name: "Extra Heavy-Duty Backup Generator (150KVA)", price: 45000 },
      { id: "add-6-4", name: "Action Fireworks Stage Finale (Indoor safe)", price: 25000 }
    ],
...
export const MOCK_BOOKINGS = [
  ...
  },
  {
    ...
    date: "2026-05-30",
    totalPrice: 113000,
    addons: ["Smoke Machine with LED Lights", "Extra Pair of Surround Speakers"],
    status: "Confirmed",
    location: "Colombo"
  },
  {
  ...
  },
  {
    ...
    date: "2026-05-29",
    totalPrice: 118000,
    addons: ["Heavy Dry Ice 'Dancing on Clouds' Fog", "Custom Monogram/Name Laser Gobo Projection"],
    status: "Pending Review",
    location: "Gampaha"
  }
];
